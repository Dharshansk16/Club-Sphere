          ...
          <form onSubmit={props.callHandleSubmit} className="mt-4">
            <div className="mb-8">
              ...
              <input
                ...
                className="bg-stone-400 font-bold text-md text-stone-700 w-full p-2 placeholder:text-gray-500 placeholder:font-normal border border-gray-300 rounded mt-1 transition transform hover:scale-105 duration-300 ease-in-out"
                required
              />
            </div>
            <div className="mb-6">
              ...
              <input
                ...
                className="bg-stone-400  font-bold text-md text-stone-700 w-full p-2 placeholder:text-gray-500 border border-gray-300 rounded mt-1 transition transform hover:scale-105 duration-300 ease-in-out"
                required
              />
            </div>
            <div className="mb-1">
